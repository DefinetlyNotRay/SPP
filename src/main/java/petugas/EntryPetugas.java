 ...
 * @author Eren
 */
public class EntryPetugas extends javax.swing.JFrame {

    /**
     * Creates new form EntryPetugas
     */
     Connection c;
    String sql;
    Statement stmnt;
...
private void populateBulanBayarCombo() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EntryPetugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EntryPetugas().setVisible(true);
            }
        });
    }
