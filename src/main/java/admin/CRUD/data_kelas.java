...
public class data_kelas extends javax.swing.JFrame {
     ...
     */
      public void TampilData() {
        ...
        TableModel.addColumn("Kompetensi Keahlian");
        ...
        try {
            ...
            sql = "SELECT * FROM `data_kelas`"; // SQL query to retrieve data
...
private String selectedId;
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        if (selectedRowData != null) {
            int id_kelas = Integer.parseInt(selectedRowData[0].toString());
            String nama_kelas = selectedRowData[1].toString();
            String kompetensi_keahlian = selectedRowData[2].toString();
          

            // Pass the data to data_akunEdit
            admin.CRUD.edit.data_kelas editForm = new admin.CRUD.edit.data_kelas(id_kelas, nama_kelas, kompetensi_keahlian);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if (confirm == 0) {
            try {
                ...
                java.sql.PreparedStatement statement = conn.prepareStatement("delete from data_kelas where id_kelas ='" + selectedId + "'");
        ...
        String countQuery = "SELECT COUNT(id_kelas) FROM data_kelas;";
        ...
        try {
            ...
            if (totalRecords > 0) {
                String resetAutoIncrementQuery = "ALTER TABLE data_kelas AUTO_INCREMENT = " + (totalRecords + 1);
